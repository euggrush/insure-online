...
:root {
  ...
  --bs-body-font-family: "Neometric Alt", -apple-system, "Neometric Alt",
    "Roboto", "Arial", "sans-serif";
  --bs-font-sans-serif: "Neometric Alt", -apple-system, "Neometric Alt",
    "Roboto", "Arial", "sans-serif";
}
html {
  height: 100%;
...
.text-primary {
  --bs-text-opacity: 1;
  color: rgba(244, 98, 58, var(--bs-text-opacity)) !important;
}
